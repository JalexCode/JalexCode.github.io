...
const Footer = () => {
  return (
    <div className="flex sssm:flex-col ssm:flex-col lg:flex-row bg-indigo-600 dark:bg-slate-800 dark:bg-opacity-60 p-8 h-fit w-full justify-between items-center text-white relative">
